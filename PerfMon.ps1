...
$ComputerList = (get-content 'C:\dev\List.txt')

$sampleInterval = 30 #Collection interval in seconds.
$maxSamples = 360 #How many samples should be collected at the interval specified. Set to 0 for continuous collection. 240 at 15 seconds would be an hour of collection
